...
function closeSideOfCustomerLogin() {
    document.getElementById("customerLogin").className = 'customerPanelLogin';
}
var adminAccount = {
...
var products = {
    footwears: {
        bonzesandal: new Products("Footwears", "Bonze shoe", 1200, "Brown/Blue", "Yes", "35/32/30"),
        learshoes: new Products("Footwears", "Flat chappal", 800, "Brown/Blue/Black", "Yes", "18/21/38"),
        candyshoes: new Products("Footwears", "Candy sandal", 1900, "Light-Blue", "Yes", "30/27"),
        cattyshoes: new Products("Footwears", "Sportshoes", 1300, "Burgendy", "No", "32"),
        skvlfsandal: new Products("Footwears", "Bata", 700, "Black", "Yes", "26/30"),
        peshawarisandal: new Products("Footwears", "Flat sandal", 2400, "Black/Brown/Grey", "No", "35/32"),
    },
    clothes: {
        addidashoody: new Products("Clothes", "Addidas hoody", 2100, "Grey/Light-Red", "Yes", "32-26"),
        bossshirt: new Products("Clothes", "Boss Jeans", 1000, "Blue/Off-White", "No", "24-28"),
        chinospant: new Products("Clothes", "Zara longfrock", 650, "Green-Dark", "Yes", "28-34"),
        handytshirt: new Products("Clothes", "Trendy Gown", 300, "Red/Mehrun", "No", "23-27"),
        khankurta: new Products("Clothes", "Bridallahenga", 1650, "Black/Blue/Grey", "Yes", "20-41"),
        denimnarrow: new Products("Clothes", "Saree", 1900, "Blue/Dark-Blue", "Yes", "28-32"),
    },
    laptops: {
        bosswrist: new Products("laptops", "Acer", 44000, "Black", "Yes", "15"),
        eaglecandy: new Products("laptops", "Dell", 50000, "Blue", "No", "14"),
        armanicab: new Products("laptops", "Lenovo", 41800, "Black", "Yes", "16"),
        rolexraz: new Products("laptops", "Apple", 90000, "Silver", "Yes", "15"),
        radoblacky: new Products("laptops", "Hp", 33000, "Silver", "Yes", "16"),
        appleiclock: new Products("laptops", "victus", 27300, "Silver", "No", "13")
    },
}
function filter() {
...
function insertData(id) {
    ...
    if (id === "footwears") {
        ...
        plus.setAttribute("onclick", 'details(' + "'" + name + "'" + ',' + "'" + './f7.jpg' + "'" + ')');
        ...
        p.setAttribute("onclick", 'details(' + "'" + name + "'" + ',' + "'" + './f7.jpg' + "'" + ')')
        ...
        editBtn.setAttribute("onclick", 'details(' + "'" + name + "'" + ',' + "'" + './f7.jpg' + "'" + ')')
    ...
    if (id === "watches") {
        ...
        counterForFoot++;
        var maintarget = document.getElementById("newAddedOflaptops");
        ...
        var plus = document.createElement("div");
        plus.setAttribute("class", "b");
        plus.setAttribute("onclick", 'details(' + "'" + name + "'" + ',' + "'" + './lp7.jpg' + "'" + ')');
        var plustext = document.createTextNode("+");
        plus.appendChild(plustext);
        subDiv.appendChild(plus);
        mainDiv.appendChild(subDiv);
        ...
        p.setAttribute("class", "proInfoN");
        p.setAttribute("id", objName + "1");
        p.setAttribute("onclick", 'details(' + "'" + name + "'" + ',' + "'" + './lp7.jpg' + "'" + ')')
        var ptext = document.createTextNode(name);
        p.appendChild(ptext);
        ...
        editBtn.setAttribute("class", "adminBtnsEdit");
        editBtn.setAttribute("title", "More");
        editBtn.setAttribute("onclick", 'details(' + "'" + name + "'" + ',' + "'" + './lp7.jpg' + "'" + ')')
        var editBtnFa = document.createElement("i");
        editBtnFa.setAttribute("class", "fa fa-arrow-up");
        editBtn.appendChild(editBtnFa);
        var editBtnText = document.createTextNode(" MORE");
        ...
        maintarget.appendChild(mainDiv);
        var a = document.getElementById("laptopsAdd");
        a.removeAttribute("onclick");
        a.style.backgroundColor = "rgb(164, 252, 164)"
    }
}
